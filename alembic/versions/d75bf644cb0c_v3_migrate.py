...
def upgrade() -> None:
    ...
    op.create_table('bucket_product',
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['address_id'], ['user_address.id'], ondelete='SET NULL'),
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['address_id'], ['user_address.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['courier_id'], ['courier_profile.id'], ondelete='SET NULL'),
    ...
    op.create_table('payment_process',
    sa.Column('user_id', sa.SmallInteger(), nullable=False),
    sa.Column('order_id', sa.SmallInteger(), nullable=False),
    ...
    op.create_table('promo_code_report',
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['payment_id'], ['payment_process.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['wallet_id'], ['wallet.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
